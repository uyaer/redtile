...
(function (root) {
    ...
    if (typeof(exports) !== "undefined" && exports._) {
        ...
        //try{
        //   cc.sys.localStorage = require('localStorage');
        //}catch(error){
        //	cc.sys.localStorage = require('./localStorage.js').localStorage;
        //}
    ...
    Bmob._getInstallationId = function () {
        ...
        Bmob._installationId = cc.sys.localStorage.getItem(path);
    ...
    Bmob._request = function (route, className, objectId, method, dataObject) {
        ...
        if (route !== "batch" &&
            ...
            route !== "users" && !(/users\/[^\/]+\/friendship\/[^\/]+/.test(route))) {
...
(function (root) {
    ...
    Bmob.User = Bmob.Object.extend("_User", /** @lends Bmob.User.prototype */ {
        ...
        current: function () {
            ...
            var userData = cc.sys.localStorage.getItem(Bmob._getBmobPath(
